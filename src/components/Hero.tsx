            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
                <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
                    ...
                    <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-4">
                        ...
                        <div className="front-medium text-red-600 text-2xl sm:text-4xl sm:pb-8 pb-4">$18.36</div>
                    ...
                    <div className="relative">
                        ...
                        <div className="front-medium text-red-600 text-2xl sm:text-4xl pb-8">$25</div>
                    ...
                    <div className="relative">
                        ...
                        <p className="text-gray-500 text-xl pt-4">Starting At</p>
                        <div className="front-medium text-red-600 text-2xl sm:text-4xl pb-8">$10</div>
                        <div className="bg-accent hover:bg-accentDark text-white rounded-full w-fit  flex items-center gap-4 px-4 py-2 text-[14px] cursor-pointer"> Shop Now <BsArrowRight/> {""}
                        </div>
                    </div>
                    </div>
